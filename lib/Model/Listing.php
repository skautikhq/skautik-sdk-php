...
class Listing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('price_per_sqm', $data ?? [], null);
    ...
    {
        return $this->container['price_per_sqm'];
    }

    /**
     * Sets price_per_sqm
     *
     * @param float|null $price_per_sqm price_per_sqm
     *
     * @return self
     */
    public function setPricePerSqm($price_per_sqm)
    {
        if (is_null($price_per_sqm)) {
            throw new \InvalidArgumentException('non-nullable price_per_sqm cannot be null');
        }
        $this->container['price_per_sqm'] = $price_per_sqm;
